...
import {
  ...
  ChevronRight, Compass, LineChart, AlertTriangle
} from "lucide-react";
...
export default function Planner() {
  ...
  return (
    <div className="flex h-screen overflow-hidden animate-fade-in" style={{ background: "#030014" }}>
      ...
      {/* ── MAIN CONTENT AREA ── */}
      <main className="flex-1 overflow-y-auto p-6 text-left flex flex-col gap-6">
